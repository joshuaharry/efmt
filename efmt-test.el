...
(describe
 ...
 (it "Should error when we can't handle the major mode"
 ...
 (it "Should pass when the major mode is part of the list"
     (let ((*efmt-format-alist* `((lisp-interaction-mode ,(lambda () nil)))))
       (expect (functionp (efmt--validate "foo")) :to-be t))))

(describe
 "Finding and replacing <TARGET>"
